            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="leading-tight">
                <h1 className="text-lg font-black text-slate-900 tracking-tighter">
                  <span className="text-blue-600">A</span>THENA
                </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="text-white font-black tracking-tight">ATHENA</h3>
            </div>
            <p className="text-sm leading-relaxed max-w-sm text-slate-500">
              AnesTHesiology Exploration of New Advances. <br/>
          ...
          <div className="text-right flex flex-col justify-end space-y-4">
            ...
            <div className="text-xs space-y-1">
              <p>© {new Date().getFullYear()} ATHENA. All rights reserved.</p>
